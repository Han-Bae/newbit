...
+ "		<span style=\"color: blue; background-color: black;\">아이디 확인</span> 안내입니다."
+ "	</h1>"
...
+ "	</p>"
+ "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://"+myIP+"/www/account/login.blp\" target=\"_blank\"><p style=\"display: inline-block; width: 210px; height: 45px; margin: 30px 5px 40px; background: blue; line-height: 45px; vertical-align: middle; font-size: 16px;\">아이디 확인</p></a>"
+ "</div>";
	...
	public void sendJoin(AccountVO aVO, Session session) {
		...
		String content = "<div style=\"font-family: 'Apple SD Gothic Neo', 'sans-serif' !important; width: 540px; height: 600px; border-top: 4px solid blue; margin: 100px auto; padding: 30px 0; box-sizing: border-box;\">\r\n"
				+ "	<h1 style=\"margin: 0; padding: 0 5px; font-size: 28px; font-weight: 400;\">\r\n"
				+ "		<span style=\"font-size: 15px; margin: 0 0 10px 3px;\">NewBit Store</span><br />\r\n"
				+ "		<span style=\"color: blue; background-color: black;\">메일인증</span> 안내입니다.\r\n"
				+ "	</h1>\r\n"
				+ "	<p style=\"font-size: 16px; line-height: 26px; margin-top: 50px; padding: 0 5px;\">\r\n"
				+ "		안녕하세요.<br />\r\n"
				...
				+ "	</p>\r\n"
				+ "\r\n"
				+ "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://"+myIP+"/www/account/checkMail.nbs"
				...
				+ "			http://"+myIP+"/www/account/checkMail.nbs"
				+ "\r\n"
				+ "		</p>\r\n"
				+ "	</div>\r\n"
				+ "</div>";
