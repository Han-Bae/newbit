...
+ "		<span style=\"color: purple; background-color: black;\">아이디 확인</span> 안내입니다."
+ "	</h1>"
...
+ "	</p>"
+ "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://"+myIP+"/www/account/login.blp\" target=\"_blank\"><p style=\"display: inline-block; width: 210px; height: 45px; margin: 30px 5px 40px; background: purple; line-height: 45px; vertical-align: middle; font-size: 16px;\">아이디 확인</p></a>"
+ "</div>";
