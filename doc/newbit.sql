...
CREATE TABLE newbit_challenge(
   ...
   newbit_no NUMBER(4)
	CONSTRAINT NBC_NBNUM_FK REFERENCES newbit_game(no)
...
CREATE TABLE account_challenge(
   ...
   newbit_no NUMBER(4)
	CONSTRAINT ACCOUNTC_NBNUM_FK REFERENCES newbit_game(no)
...
CREATE TABLE sale(
   ...
   newbit_no NUMBER(4)
	CONSTRAINT SALE_NBNUM_FK REFERENCES newbit_game(no)
